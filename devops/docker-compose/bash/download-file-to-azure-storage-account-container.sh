...
az storage blob download --connection-string "$AZURE_STORAGE_CONNECTION_STRING" --container-name mycontainer --name myblob --file ./sample-download.txt

# Access Azurite Storage Explorer via a web browser
echo "Access Azurite Storage Explorer via: http://azurite:10002/devstoreaccount1"
